...
const std::size_t Niveau_3::_numero(3);

const QString Niveau_3::_nom("Tourne à gauche");
...
void Niveau_3::initialise_modelisation()
{
	// Initialise le niveau
	Niveau::initialise_modelisation();
/*
	// Initialise la modélisation des zones valides du niveau 3
	for (Zone_valide & zone_valide: _zones_valides)
	{
		zone_valide.initialise_modelisation();
	}
*/
	// Initialise la modélisation des éléments du niveau 3
...
void Niveau_3::modelise()
{
	glPushMatrix();
	{
		...
		positionne_oriente();
/*
		// Modélise les zones valides du niveau 3
		for (Zone_valide & zone_valide: _zones_valides)
		{
...
std::size_t const & Niveau_3::numero() const
{
	return _numero;
}

QString const & Niveau_3::nom() const
{
	return _nom;
}
